...
export default function MatchPointTracker({ match, homePoints, awayPoints, onViewScorecard }: MatchPointTrackerProps) {
  ...
  return (
    <div className="max-w-6xl mx-auto mb-4 relative" data-component-name="MatchPointTracker">
      ...
      <div className="relative overflow-hidden rounded-lg backdrop-blur-sm bg-gradient-to-r from-[#00df82]/30 to-[#4CAF50]/20 border border-[#00df82]/20 p-4 shadow-lg">
        ...
        <div className="relative">
          <h2 className="text-xl font-audiowide text-white text-center mb-4">Match Scorecard</h2>
          
          <div className="bg-[#001a0d]/80 border border-[#00df82]/10 rounded-lg p-4 backdrop-blur-sm">
            <div className="flex items-center justify-between">
              ...
              {/* Divider */}
              <div className="text-xl font-audiowide text-white mx-4">-</div>
