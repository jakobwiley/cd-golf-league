          ...
          {onViewScorecard && (
            <div className="mt-2 md:mt-6">
              <button 
                ...
                className="w-full group relative overflow-hidden px-3 md:px-5 py-1 md:py-2 text-white bg-gradient-to-r from-[#00df82]/20 to-[#4CAF50]/10 hover:from-[#00df82]/40 hover:to-[#4CAF50]/30 rounded-lg transition-all duration-300 border border-[#00df82]/30 hover:border-[#00df82] backdrop-blur-sm text-xs md:text-sm font-audiowide shadow-[0_0_10px_rgba(0,223,130,0.2)] hover:shadow-[0_0_15px_rgba(0,223,130,0.4)] transform hover:scale-105"
              >
                ...
                <span className="relative flex items-center justify-center">
                  <ClipboardList className="w-3 h-3 md:w-4 md:h-4 mr-1 md:mr-2" />
                  View Scorecard
                </span>
              </button>
            </div>
