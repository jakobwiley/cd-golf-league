      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        <div className="relative overflow-hidden rounded-3xl backdrop-blur-sm bg-gradient-to-r from-[#00df82]/30 to-[#4CAF50]/20 mb-8">
          ...
          <div className="relative px-8 py-6">
            <h1 className="text-4xl font-audiowide text-white mb-2">Matches</h1>
            <p className="text-white/90 font-orbitron tracking-wide">View and play scheduled matches</p>
          </div>
