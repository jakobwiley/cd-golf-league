...
export default function SchedulePage({ 
  ...
  try {
    // Group matches by week
    const matchesByWeek = groupMatchesByWeek(initialMatches);
    ...
    return (
      <div className="min-h-screen bg-[#030f0f] relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
          {/* Updated header to match the rest of the app - removed Setup Schedule button */}
          ...
          {weekNumbers.length === 0 ? (
            ...
            weekNumbers.map(weekNumber => {
              ...
              const weekDate = matchesByWeek[weekNumber][0]?.date;
              ...
              return (
                <div key={weekNumber} className="mb-4">
                  ...
                  {/* Collapsible content */}
                  {isExpanded && matchesByWeek[weekNumber].length > 0 && (
