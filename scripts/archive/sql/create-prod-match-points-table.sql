-- SQL to create the MatchPoints table in the production Supabase database
-- Copy and paste this into the Supabase dashboard SQL editor for the production database (ylhwysupdkmbunaascky)
